...
02 Movement: This represents the muddled up thoughts I experience throughout my everyday life. They happen when I interact with people or present ideas. A way in which this is represented is how the words first appear on the screen and don't disappear. I decided to include the interactive circles in order to convey the idea of how interaction adds more chaos to my mind. I origionally wanted the circle to grow in the centre of the cirle but faced some challenges with the code. This also happened where I wanted the circle to not leave a trail but was unable to get it to work without causing the text to disappear, I understand why this happened as when I put the background in the draw tab it would loop with the rest of the text continously covering the text and mouse interaction. 
...
04: Media: For this sketch the video involves an individual drinking a cup of coffee to which I pixelated in order to imply that their action has been computerised. A pixelated image gives off the impression that something is loading or unfinished which was important to me as I wanted to hint at the future of AI and how we see some of our actions becoming computerised - such as thinking (Chat GPT). We rely soo much on computers to do things for us now. I chose to incorporate a glitchy voice aswell as it reminded me of the early 2000s phone toys you could get from Mcdonalds and how the audio was always a bad quality and seemed unfinished. I found this supported my concept the most. 
